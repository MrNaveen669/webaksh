          ...
          <div className="text-center lg:text-left">
            ...
            >
              ...
              <motion.button
                ...
                className="px-8 py-4 bg-white text-gray-900 font-semibold rounded-full border-2 border-gray-200 hover:border-indigo-600 hover:text-indigo-600 transform transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                Get in Touch
              </motion.button>
            </motion.div>
