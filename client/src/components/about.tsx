...
export default function About() {
  const features = [
    {
      ...
      description: "Work directly with our founders - no account managers or middlemen, just passionate experts who care about your success",
      gradient: "from-blue-500 to-indigo-600"
    },
    {
      icon: Heart,
      title: "Mission-Driven",
      description: "We're passionate about empowering small businesses to compete with industry giants through smart digital solutions",
      gradient: "from-pink-500 to-rose-600"
    },
    {
      icon: Zap,
      title: "Results-Focused",
      description: "Every project is designed with clear goals in mind - increased sales, better engagement, and measurable growth",
      gradient: "from-emerald-500 to-teal-600"
    },
    {
      icon: Award,
      title: "Proven Excellence",
      description: "5+ years of combined expertise with a track record of delivering projects that exceed expectations",
  ...
  const stats = [
    ...
    { value: "5+", label: "Years Experience", color: "text-emerald-600" },
    { value: "100%", label: "Client Satisfaction", color: "text-orange-600" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto font-inter leading-relaxed">
            We're a passionate team of digital innovators dedicated to transforming small businesses into online powerhouses. 
            Our mission is simple: make cutting-edge digital solutions accessible to every entrepreneur with big dreams.
          </p>
        </motion.div>
              ...
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm font-inter leading-relaxed">{feature.description}</p>
                  </motion.div>
                );
              })}
            </div>
